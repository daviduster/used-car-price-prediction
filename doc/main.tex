...
\hline
Preprocesamiento & Fecha Subida & Posición & Algoritmo & Score Train & Score Test \\ \hline
\multirow{3}{*}{\begin{tabular}[c]{@{}c@{}}Valores perdidos por media y moda\\ Etiquetado con LabelEncoding\\  Balanceo con RandomOverSampling y Skewed y outliers \\  \end{tabular}} & - & - & Catboost &  &  \\ \cline{2-6} 
 &  &  &  &  &  \\ \cline{2-6} 
 &  &  &  &  &  \\ \hline
\end{tabular}}
\end{center}
